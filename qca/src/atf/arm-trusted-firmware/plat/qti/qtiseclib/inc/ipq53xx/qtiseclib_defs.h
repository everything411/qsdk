...
#define QTISECLIB_INT_ID_MEM_NOC_ERROR			(0x11E)
#define QTISECLIB_INT_ID_SYSTEM_NOC_ERROR		(0xE8)
#define QTISECLIB_INT_ID_PC_NOC_ERROR			(0xE6)
#define QTISECLIB_INT_ID_NSS_NOC_ERROR			(0x71)
